...
public class MapValidator {
	...
	public boolean validateContinentValue() throws InvalidMapException {
		...
		for (Entry<String, Integer> entry : continentValue.entrySet()) {
			...
			if (continentValue.get(key) > continentTerritories.get(key).size()) {
				throw new InvalidMapException("Number of territories in a continent should be greater than continent's winning value.");
			}
